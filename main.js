...
//get a random cat image from API
...
fetch('https://api.countapi.xyz/get/codykoinabox.github.io/catfactscounter')
.then(response => (response).json())
...
fetch('https://api.countapi.xyz/update/codykoinabox.github.io/catfactscounter/?amount=1')